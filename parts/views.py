...
from .forms import EdigOriginalForm, EditSubstitute
...
def delete_part(request, pk):
    ...
    return render(request, 'parts/admin/admin_delete_part.html', context)
...
def add_substitute(request, pk):
    ...
    return render(request, 'parts/admin/add_subtitutes.html', context)
